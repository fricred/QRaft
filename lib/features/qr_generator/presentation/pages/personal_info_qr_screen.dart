...
class _PersonalInfoQRScreenState extends ConsumerState<PersonalInfoQRScreen>
  ...
  Widget build(BuildContext context) {
    final personalInfoState = ref.watch(personalInfoFormProvider);
        ...
        children: [
          Expanded(
            child: TabBarView(
              ...
              children: [
                // Form Tab
                PersonalInfoForm(onContinue: () => _tabController.animateTo(1)),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Expand button
              if (ref.watch(personalInfoFormProvider).isValid)
                GestureDetector(
