...
class _EmailQRScreenState extends ConsumerState<EmailQRScreen>
  ...
  Widget build(BuildContext context) {
    final emailState = ref.watch(emailFormProvider);
        ...
        children: [
          Expanded(
            child: TabBarView(
              ...
              children: [
                // Form Tab
                EmailForm(onContinue: () => _tabController.animateTo(1)),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Expand button
              if (ref.watch(emailFormProvider).isValid)
                GestureDetector(
